...
hl-github-mobile-comment-unchanged = Мобильное приложение GitHub: комментирование неизменённых строк в файлах запросов на слияние
hl-closing-down-notice-of-legacy-copilot-metrics-apis = Уведомление о закрытии устаревших API метрик Copilot
hl-improved-search-for-github-issues-in-public-preview = Улучшенный поиск среди тем GitHub в публичной предварительной версии
hl-acp-support-in-copilot-cli-is-now-in-public-preview = Теперь в командном инструменте Copilot стала доступна поддержка ACP в рамках публичной предварительной версии
hl-github-mcp-server-new-projects-tools-oauth = MCP-сервер GitHub: новые инструменты для управления проектами, фильтрация по области действия OAuth и новые функции
hl-changes-to-github-dependabot-pull-request-comment-commands = Изменения в командах комментирования запросов на слияние «GitHub Dependabot»
hl-introducing-agents-tab-in-your-repository = Представляем вкладку «Агенты» в вашем репозитории
hl-gpt52codex-available-in-ides = Теперь в «Visual Studio», ИСР JetBrains, Xcode и Eclipse доступна GPT-5.2-Codex
hl-improved-files-changed-on-by-default = Теперь улучшенная страница «Изменённые файлы» в запросах на слияние включена по умолчанию
...
hl-github-dependabot = «GitHub Dependabot»
...
### Фразы из заголовков
hl-closing-down-notice-of-legacy = Уведомление о закрытии устаревших
hl-closing-down-notice-of = Уведомление о закрытии
hl-closing-down-notice = Уведомление о закрытии
hl-legacy = устаревших
hl-metrics-apis = API метрик
hl-apis = API
hl-improved-search-for = Улучшенный поиск среди
hl-improved-search = Улучшенный поиск
hl-improved = Улучшенный
hl-search-for = поиск среди
hl-github-issues = тем GitHub
hl-acp-support-in = поддержка ACP в
hl-acp-support = поддержка ACP
hl-copilot-cli = командном инструменте Copilot
hl-is-now-in-public-preview-text = стала доступна в рамках публичной предварительной версии
hl-github-mcp-server = MCP-сервер GitHub
hl-new-projects-tools = новые инструменты для управления проектами
hl-oauth-scope-filtering = фильтрация по области действия OAuth
hl-new-features = новые функции
hl-changes-to = Изменения в
hl-pull-request-comment-commands = командах комментирования запросов на слияние
hl-comment-commands = команды комментирования
hl-introducing-the = Представляем
hl-introducing = Представляем
hl-agents-tab = вкладку «Агенты»
hl-agents-tab-in-your-repository = вкладку «Агенты» в вашем репозитории
hl-in-your-repository = в вашем репозитории
hl-your-repository = вашем репозитории
hl-jetbrains-ides = ИСР JetBrains
hl-files-changed-page = страница «Изменённые файлы»
hl-on-by-default = включена по умолчанию
hl-by-default = по умолчанию
